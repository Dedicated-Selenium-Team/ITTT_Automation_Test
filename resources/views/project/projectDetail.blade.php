          ...
          <div class="wrap-project assigned-projects cf">
            ...
            <?php if ($role_id == 1) {?>
              <div class="actions cf">
                ...
                <!--<span>Action</span> -->
                <div>
                  <a href="#" title="Edit" class="edit-action" data-id="{{$my_allproject->project_id}}">edit</a>
            ...
            <div class="wrap-project unassigned-projects cf">
              <?php if ($role_id == 1) {
                ...
                <div class="actions cf">
                  <!--<span>Action</span> -->
                  <div>
                    <a href="#" title="Edit" class="edit-action" data-id="{{$project_detail->project_id}}">edit</a>
             <!--  <select id="project_action" class="edit-action-arrow">
                <option value = "1">Please Select</option>
